...
# Copyright (c) 2026.
#
# Standalone EGM (Extended GPU Memory) bandwidth microbenchmark for GB200/NVL72.
#
# This script does NOT depend on Megatron-LM code. It uses CUDA Driver API (cuda-python)
# to allocate HOST_NUMA pinned memory via cuMemCreate (EGM), maps it into the process VA,
# and measures GPU<->EGM copy bandwidth using cuMemcpyDtoDAsync (device-to-device copy engine,
# where the destination/source may physically reside in Grace CPU memory).
#
